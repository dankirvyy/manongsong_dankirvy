    ...
    <div class="form-container">
        ...
        <form action="<?=site_url('register');?>" method="post">
            ...
            <div class="form-group">
                ...
                <select id="role" name="role" required style="width: 100%; padding: 0.8rem 1rem; background-color: var(--color-input-bg); border: 1px solid var(--color-border); border-radius: 6px; color: var(--color-text-primary); font-family: var(--font-mono); font-size: 1rem; box-sizing: border-box; transition: border-color 0.2s ease, box-shadow 0.2s ease;">
